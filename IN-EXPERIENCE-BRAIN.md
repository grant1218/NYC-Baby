...
**IN — Make New York yours.**

IN is a social experience platform for making NYC your own. It is not a generic recommendation engine. It should understand a member, understand New York, understand what is happening across the member's real-world network, create a move, and then help make that move happen.

**No two people's IN should look the same.**
**No two people's FUCK IT should mean the same thing.**

## Founder Seed Intelligence

Grant is the first editor and trainer of IN's NYC judgment.

The goal is NOT for Grant to manually curate every member's experience. The goal is to encode how Grant thinks about experiencing New York so IN can apply that judgment automatically, combine it with each member's own preferences and behavior, and improve from feedback.

The city is the raw material. Grant's NYC judgment is the initial operating intelligence. The member makes it personal.

### The model

GRANT'S NYC BRAIN
× MEMBER'S PERSONAL BRAIN
× LIVE NYC
× LIVE NETWORK
→ EXPERIENCE IN CAN ACTUALLY CREATE
...
It is not a nightlife button. It is a personal intent shortcut whose meaning is learned per member.

### Mikey — Test Subject #1

Mikey is the guinea pig, not the product.

For Mikey, current working interpretation is approximately:

> Maximize the next three hours. High social upside. Low friction. Spontaneous. People worth seeing or meeting. A night with momentum.

His conceptual objective function:

FUN = chemistry + social energy + spontaneity + proximity + novelty + access + momentum − friction

This is only Mikey's current model. Do not generalize it to every member.
...
Another member's FUCK IT may mean a relaxing dinner, culture, a date, a quiet escape, a last-minute weekend, a workout, a family activity, an unusual event, or something else entirely.

The engine must first answer:

> **What does FUCK IT mean for this person, in this context, right now?**
...
For opportunity/experience `o`, member `m`, and moment `t`:
